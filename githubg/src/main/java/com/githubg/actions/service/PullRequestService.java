...
public class PullRequestService {
	...
	public ResponseEntity<?> createPullRequest(String authToken, CreatePRRequest prRequest)
			throws Exception {
		validateCreatePullRequest(prRequest);

		String url = buildRepoUrl(prRequest.getUserName(), prRequest.getRepository()) + "/pulls";
		log.debug("createPullRequest::url ", url);
		log.debug("createPullRequest::authToken ", authToken);
		log.debug("createPullRequest::headers ", prRequest.getPullRequest());
		HttpHeaders httpHeaders = new HttpHeaders();

		httpHeaders.setContentType(MediaType.APPLICATION_JSON);
		httpHeaders.set(AUTHORIZATION, (String.join("token ", authToken)));
	...
	public ResponseEntity<?> mergePullRequest(String authToken, MergePRRequest prRequest)
			throws Exception {
		...
		log.debug("mergePullRequest::authToken ", authToken);
		log.debug("mergePullRequest::PullRequest ", prRequest.getPullRequest());
		HttpHeaders httpHeaders = new HttpHeaders();
